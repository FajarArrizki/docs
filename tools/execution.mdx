...
These tools now also power the `execution_snapshot` pipeline node, which gathers execution-readiness context before the final answer instead of waiting for the final runtime to discover it ad hoc.
