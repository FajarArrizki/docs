...
1. **Real-time Price Updates**
   ...
   - Automatic symbol normalization (SOL_USDC â†’ SOL)
...
|---------|----------|-------|
| Real-time Price | âœ… Ticker + Trade | âœ… Market Data |
| OHLC/Kline | âœ… 6 intervals | âŒ Not available |
| 24h Statistics | âœ… High/Low/Volume | âœ… Change/Volume |
| Futures Data | âŒ Spot only | âœ… OI + Funding |
...
2. âœ… OHLC/Kline data
3. âœ… TradingView integration
4. âœ… API endpoints
5. ðŸ”„ Historical data from Backpack REST API (optional)
6. ðŸ”„ Depth/orderbook data (optional)
7. ðŸ”„ Advanced chart indicators (optional)
